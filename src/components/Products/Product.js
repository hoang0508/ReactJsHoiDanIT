...
const Product = () => {
  ...
  // Click PreView img
  const handleClickPreviewIndex = () => {
    let indexImg = images.findIndex((item) => item === currenImage);
        ...
        <div className="product-list">
          <div className="product-item-top">
            <img
              src={currenImage}
              alt=""
              onClick={() => handleClickPreviewIndex()}
            />
          </div>
          <div className="product-item-bottom">
            <div
              className={`${
                currenImage === sneaker1 ? "active" : "product-item-image"
              }`}
            >
              <img
                src={sneaker1}
            ...
            <div
              className={` ${
                currenImage === sneaker2 ? "active" : "product-item-image"
              }`}
            >
              <img
                src={sneaker2}
            ...
            <div
              className={` ${
                currenImage === sneaker3 ? "active" : "product-item-image"
              }`}
            >
              <img
                src={sneaker3}
            ...
            <div
              className={` ${
                currenImage === sneaker4 ? "active" : "product-item-image"
              }`}
            >
              <img
                src={sneaker4}
